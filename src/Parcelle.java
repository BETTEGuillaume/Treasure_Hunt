...
public class Parcelle {
	 ...
	 * <p>
	 * Chaque parcelle est au départ initialisée avec le type Vide (qui correspond à la terre, ou à la mer)
	 * </p>
	 * 
	 * @see Vide
	 * @see Parcelle#obj
	...
	/**
	 * Regarde si le débarquement du navire est possible (pas entouré de rochers).
	 * 
